			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">قائمة فاتورة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">تسجيل فاتورة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">عرض فواتير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">الفواتير المستحقة</a></li>
						</ul>
					</li>
